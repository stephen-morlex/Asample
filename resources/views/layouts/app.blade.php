...
<script>
    ...
    $(document).ready(function(){
        ...
        $('#add').click(function(){
            i++;
            $('#dynamic_field').append('<div class="row" id="row'+i+'"><div class="medium-3 small-12 columns"><label>High school name</label><label><input type="text" name="high_school" placeholder="The name of  your high school here..." /></label></div> <div class="medium-3 small-12 columns"><label>School Address</label><label><input type="text" name="school_address" value="{{ old('school_address') }}" placeholder="The address of your school here..." /></label></div><div class="medium-2 small-12 columns"><label>When started</label><label><input type="date" name="when_started_highschool" value="{{  old('when_started_highschool') }}" placeholder="mm/dd/yyyy" /></label></div><div class="medium-2 small-12 columns"><label>When ended</label><label><input type="date" name="when_ended_highschool" placeholder="mm/dd/yyyy" /></label></div><div class="medium-2 small-12 columns"><label>&nbsp;</label><button  type="button" name="remove" id="'+i+'" class="btn_remove button alert">Remove</button></div></div><!-- Row Ends /-->');
...
<script>
    $(document).ready(function(){
         ...
         $('#add2').click(function(){
                j++;
                $('#dynamic_field2').append('<div class="row" id="row'+j+'"><div class="medium-3 small-12 columns"><label>Colledge name</label><label><input type="text" name="colledge" placeholder="The name of colledge here..." /></label></div><div class="medium-3 small-12 columns"><label>School Address</label><label><input type="text" name="colledge_address" placeholder="The address of your school here..." /></label></div><div class="medium-2 small-12 columns"><label>When started</label><label><input type="date" name="when_started_colledge" placeholder="mm/dd/yyyy" /></label></div><div class="medium-2 small-12 columns"><label>When Ended</label><label><input type="date" name="when_ended_colledge" placeholder="mm/dd/yyyy" /></label></div><div class="medium-2 small-12 columns"><label>&nbsp;</label><button  type="button" name="remove" id="'+j+'" class="btn_remove button alert">Remove</button></div></div><!-- Row Ends /-->');
    });
