        ...
        <div class="header header-new">
        	<div class="row">
                ...
                <div class="large-8 medium-8 small-12 columns text-right">
                	<p><i class="fa fa-phone"></i> +(254) 709-691000</p>
                    ...
                    <nav id="responsive-menu">
                        <ul class="menu vertical medium-horizontal" data-responsive-menu="accordion medium-dropdown">
                            ...
                            <li class="single-sub parent-nav"><a href="admission.html">Academics </a>
                                <ul class="child-nav menu vertical">
                                    <li><a href="faculty.html">Faculties, Schools & Institutes</a></li>
                                    <li><a href="programs.html">Programs</a></li>
                                    <li><a href="gallery.html">Student Service information</a></li>
                                                                          -->
                                </ul>
                            </li>
                            <li class="single-sub parent-nav"><a href="admission.html">Admissions</a>
                                <ul class="child-nav menu vertical">
                                    <li><a href="courses.html">Undergraduate Admissions</a></li>
                                    <li><a href="single-course.html">Masters & Doctoral Admissions</a></li>
                                    <li><a href="single-course.html">Doctoral Programs</a></li>
