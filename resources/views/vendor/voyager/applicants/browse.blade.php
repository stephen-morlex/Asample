                                    ...
                                    <tr>
                                        ...
                                        <td class="no-sort no-click" id="bread-actions">
                                            @foreach(Voyager::actions() as $action)
                                                ...
                                                @endif
                                            @endforeach
                                               <i class="fas fa-print" aria-hidden="true"></i><a name="" id="" class="btn btn-success" href="{{route('application.pdf',$data->id)}}" role="button"><span class="hidden-xs hidden-sm"><i class="fa fa-print"></i> Print</span></a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
