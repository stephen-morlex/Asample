                    ...
                    <div class="medium-4 small-12 columns">
                        ...
                        >
                            <div class="product-img thumbnail">
                                <a href="{{route('dean.show',$dean->slug)}}">
                                    <img class="front-image" src="{{ Voyager::image( $dean->thumbnail('cropped'))}}">
                                </a>
                                <div class="add-to-cart-top">
                                        <a href="{{route('dean.show',$dean->slug)}}" class="button primary">{{$dean->name}}</a>
                                </div>
                            </div>
                            <div class="product-info">
                                <h6><a href="{{route('dean.show',$dean->slug)}}">{{$dean->name}}</a></h6>
