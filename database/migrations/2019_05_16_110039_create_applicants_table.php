...
class CreateApplicantsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('applicants', function (Blueprint $table) {
            ...
            $table->string('colledge')->nullable();
            $table->string('colledge_address')->nullable();
            $table->string('when_started_colledge')->nullable();
            $table->string('when_ended_colledge')->nullable();
            ...
            $table->string('colledge2')->nullable();
            $table->string('colledge_address2')->nullable();
            $table->string('when_started_colledge2')->nullable();
            $table->string('when_ended_colledge2')->nullable();
            ...
            $table->string('colledge3')->nullable();
            $table->string('colledge_address3')->nullable();
            $table->string('when_started_colledge3')->nullable();
            $table->string('when_ended_colledge3')->nullable();
            ...
            $table->string('colledge_file')->nullable();
